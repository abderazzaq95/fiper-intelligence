...
export const en = {
  ...
  trade: {
    ...
    disclaimer: 'This places real orders on a Capital.com demo account using the rule-based bias engine above — it is not financial advice, and no live-money trading is implemented in this build.',
    notConfigured: 'No Capital.com demo account connected. Add CAPITAL_API_KEY, CAPITAL_IDENTIFIER and CAPITAL_PASSWORD to the backend .env — sign up free at capital.com for a demo account.',
    status: 'Status',
    ...
    outcomeUnknown: 'Closed — P&L unavailable',
...
export const ar: typeof en = {
  ...
  trade: {
    ...
    disclaimer: 'هذه الميزة تضع أوامر حقيقية على حساب Capital.com التجريبي باستخدام محرك التحيز القائم على القواعد أعلاه — وهي ليست استشارة مالية، ولا يوجد في هذا الإصدار أي تنفيذ بأموال حقيقية.',
    notConfigured: 'لا يوجد حساب Capital.com تجريبي متصل. أضف CAPITAL_API_KEY و CAPITAL_IDENTIFIER و CAPITAL_PASSWORD في ملف .env الخاص بالخادم الخلفي — سجّل مجانًا في capital.com للحصول على حساب تجريبي.',
    status: 'الحالة',
    ...
    outcomeUnknown: 'مغلقة — الأرباح/الخسائر غير متاحة',
